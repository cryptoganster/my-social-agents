...
describe('CredentialEncryptionService', () => {
  ...
  describe('Property-Based Tests', () => {
    /**
     * Feature: shared-kernel, Property: Credential Encryption Round-Trip
     * Validates: Encryption/decryption preserves original data
     */
    ...
    /**
     * Feature: shared-kernel, Property: Credential Encryption Uniqueness
     * Validates: Different IVs produce different ciphertexts
     */
    it('should produce different ciphertexts due to random IVs', () => {
      fc.assert(
        fc.property(
    ...
    /**
     * Feature: shared-kernel, Property: Credential Encryption Format
     * Validates: Encrypted format is always valid
     */
    ...
    /**
     * Feature: shared-kernel, Property: Credential Encryption Key Sensitivity
     * Validates: Wrong key always fails decryption
     */
